...
knitr::opts_chunk$set(warning = FALSE,
                      ...
                      fig.width = 7,
                      fig.align = 'center',
                      fig.path = 'figures/4B-response-characteristics/')
```
...
ggplot(data = lmm_resid1) +
    ...
    geom_hline(yintercept = 2,
               linetype = 2) +
    labs(title = expression(paste('Linear model: Level 1 residuals vs ', intensity^2)),
...
ggplot(data = lmm_resid1) +
    ...
    geom_hline(yintercept = 2,
               linetype = 2) +
    labs(title = expression(paste('Linear model: Level 1 residuals vs ', intensity^3)),
...
The response clearly varies across the quantiles. 
