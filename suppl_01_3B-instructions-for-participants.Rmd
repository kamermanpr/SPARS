...
\begin{figure}[h]
\centering
\includegraphics[height = 9.5cm, keepaspectratio]{data/spars.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 9.5cm, keepaspectratio]{data/nrs.png}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[height = 9.5cm, keepaspectratio]{data/srs.png}
\end{figure}
