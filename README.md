...
All inputs (root directory) and outputs (_/outputs_) prefixed with _suppl\_\*\*\__ are analysis scripts cited in the text of the manuscript as supplementary files. For convenience, PDF versions of these files have been included in the folder (named: _supplement\_\*.pdf_). These PDF files were produced by the scripts contained in the _supplementary\_pdfs_ branch of the SPARS repo (URL: [https://github.com/kamermanpr/SPARS/tree/supplementary_pdfs](https://github.com/kamermanpr/SPARS/tree/supplementary_pdfs)).
